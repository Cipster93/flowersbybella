...
export default function WhatupContact() {
    ...
    return (
        <aside
            ...
            className={`relative font-serif  flex items-center gap-2 text-green-500 text-4xl cursor-pointer ${!isMobile ? 'group' : ''}`}
        ...
        >
            ...
            {show && (
                <div
                    ...
                    className="absolute left-0 bottom-full -translate-x-[90%] mb-4 z-50 bg-black text-white rounded-2xl p-5 min-w-[320px]  flex flex-col items-start animate-fade-in"
                >
                    <button
                        className="absolute top-2 right-2 text-yellow-500 text-2xl font-bold rounded-full bg-black/40 px-2 py-0.5 "
