...
const DeliveryInfo = () => {
  return (
    <main
      className="mt-4 w-auto bg-black md:mt-0 flex flex-col sm:flex-row items-center sm:justify-start gap-3 sm:gap-4 px-4 py-1 rounded-xl border-b-2 border-r-2 border-t-2 border-yellow-500/40 shadow-lg"
      itemScope
