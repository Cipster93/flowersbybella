...
const DeliveryInfo = () => {
  return (
    <main
      className="mt-4 w-full bg-black md:mt-0 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 py-1 rounded-xl border-b-2 border-r-2 border-t-2 border-yellow-500/40 shadow-lg"
      itemScope
    ...
    >
      ...
      <Link
        href="tel:0728361107"
        className="flex-shrink-0 flex items-center gap-2 px-3 py-1 rounded-full text-yellow-500 font-bold text-base shadow"
        itemProp="telephone"
      >
