...
export const topics: Topic[] = [
  {
    ...
    desc: "Eleganța florilor noastre aduce rafinament și stil în orice moment. Fiecare aranjament este creat cu grijă pentru detalii, potrivit pentru evenimente speciale sau decoruri sofisticate.",
  },
  {
    title: "Rafinament",
    images: [
    ...
    desc: "Rafinamentul se regăsește în fiecare buchet, unde culorile și formele se îmbină armonios. Florile noastre sunt alese pentru a oferi o experiență vizuală deosebită și eleganță discretă.",
  },
  {
