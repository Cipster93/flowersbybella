...
export const dinamicCategory: DinamicCategory[] = [
    ...
    },
    {
        ...
        flowers: [
            { name: "Pachet lumânări și buchete pentru nunți", imgTop: "/MomenteDeNeuitat/bl1.webp", imgBottom: "/MomenteDeNeuitat/l1.webp", desc: "Buchet cu flori în tonuri pastel, pentru o notă de rafinament" },
            { name: "Pachet lumânări și buchete pentru nunți", imgTop: "/MomenteDeNeuitat/bl2.webp", imgBottom: "/MomenteDeNeuitat/l2.webp", desc: "Buchet cu flori în tonuri pastel, pentru o notă de rafinament" },
            { name: "Pachet lumânări și buchete pentru nunți", imgTop: "/MomenteDeNeuitat/bl3.webp", imgBottom: "/MomenteDeNeuitat/l3.webp", desc: "Buchet cu flori în tonuri pastel, pentru o notă de rafinament" },
            { name: "Pachet lumânări și buchete pentru nunți", imgTop: "/MomenteDeNeuitat/bl4.webp", imgBottom: "/MomenteDeNeuitat/l4.webp", desc: "Buchet cu flori în tonuri pastel, pentru o notă de rafinament" },
            { name: "Pachet lumânări și buchete pentru nunți", imgTop: "/MomenteDeNeuitat/bl5.webp", imgBottom: "/MomenteDeNeuitat/l5.webp", desc: "Buchet cu flori în tonuri pastel, pentru o notă de rafinament" },
            { name: "Pachet lumânări și buchete pentru nunți", imgTop: "/MomenteDeNeuitat/bl6.webp", imgBottom: "/MomenteDeNeuitat/l6.webp", desc: "Buchet cu flori în tonuri pastel, pentru o notă de rafinament" },
            { name: "Pachet lumânări și buchete pentru nunți", imgTop: "/MomenteDeNeuitat/bl7.webp", imgBottom: "/MomenteDeNeuitat/l7.webp", desc: "Buchet cu flori în tonuri pastel, pentru o notă de rafinament" },
            { name: "Lumânări mari de nuntă", img: "/MomenteDeNeuitat/lumanare1.webp", desc: "Lumânări mari de nuntă" },
            { name: "Buchete de mireasă", img: "/MomenteDeNeuitat/buc1.webp", desc: "Buchete de nuntă mireasă" },
            { name: "Buchete de mireasă", img: "/MomenteDeNeuitat/buc2.webp", desc: "Buchete de nuntă mireasă" },
            { name: "Buchete de mireasă", img: "/MomenteDeNeuitat/buc3.webp", desc: "Buchete de nuntă mireasă" },
            { name: "Buchete de mireasă", img: "/MomenteDeNeuitat/buc4.webp", desc: "Buchete de nuntă mireasă" },
            { name: "Buchete de mireasă", img: "/MomenteDeNeuitat/buc5.webp", desc: "Buchete de nuntă mireasă" },
            { name: "Buchete de mireasă", img: "/MomenteDeNeuitat/buc6.webp", desc: "Buchete de nuntă mireasă" },
            { name: "Buchete de mireasă", img: "/MomenteDeNeuitat/buc7.webp", desc: "Buchete de nuntă mireasă" },
            { name: "Buchete de mireasă", img: "/MomenteDeNeuitat/buc8.webp", desc: "Buchete de nuntă mireasă" },
            { name: "Buchete de mireasă", img: "/MomenteDeNeuitat/buc9.webp", desc: "Buchete de nuntă mireasă" },
        ]
    },
    {
        name: "Rafinament",
